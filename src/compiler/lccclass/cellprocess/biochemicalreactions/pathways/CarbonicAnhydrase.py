...
def Write_CellProcess(Writer, Comp, ProGen, ProcessID):
    # Indices
    Idx_AllSubstrates = ProGen.GetMolIdx_Master(Comp.Metabolism.RXN_AllSubstrates)
    Idx_EnzSubstrates = ProGen.GetMolIdx_Master(Comp.Metabolism.RXN_ENZSubstrate)
    Idx_Enzymes = Comp.Master.ID2Idx_Master[Comp.Metabolism.RXN_Enzyme]
    Coeff = Comp.Metabolism.RXN_StoichiometricMatrix_Coefficient
