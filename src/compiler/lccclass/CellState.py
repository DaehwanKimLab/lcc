...
def Write_CellState(Writer, Comp, ProGen):
    ...
    with Writer.Statement("class FCellState():"):
        ...
        with Writer.Statement("def InitializeVariablesForCellProcesses(self):"):
            ...
            Writer.BlankLine()
            Writer.Variable_("self.Count_ChromosomeElongationLengthFinalPerChromosome", 0)
            Writer.Variable_("self.Count_ChromosomeElongationLengthFinalTotal", 0)
            Writer.Variable_("self.Count_ChromosomeElongationNTPConsumption", 0)
            Writer.Variable_("self.Count_ChromosomeElongationPPiProduction", 0)
            Writer.Variable_("self.Count_ChromosomeElongationCompletedPerChromosome", 0)
            Writer.Variable_("self.Count_ChromosomeElongationCompletedTotal", 0)
            Writer.BlankLine()
