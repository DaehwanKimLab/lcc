...
class FNetwork():
    ...
    def PlotData(self):
        ...
        ax1.plot(S, 'red', label="[Substrate]")
        ax1.plot(E, 'black', label="[Enzyme]")
        ax1.plot(C, 'grey', label="[S-E complex]")
        ax1.plot(P, 'blue', label="[Product]")
        ax1.set_title('Full Model ' + 'Dynamics')
        ax1.set_xlabel('Time (a.u.)')
        ax1.set_ylabel('Concentration (a.u.)')
        ax1.legend(loc='center right')
        ax1.grid()
        
        ax2.plot(S, 'red', label="[Substrate]_full")
        ax2.plot(P, 'blue', label="[Product]_full")
        ax2.plot(S_MM, 'magenta', label="[Substrate]_reduced")
        ax2.plot(P_MM, 'green', label="[Product]_reduced")
        ax2.set_title('Full vs. Reduced Model ' + 'Dynamics')
